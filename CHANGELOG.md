...
## [0.30.0](https://github.com/idanarye/nu_plugin_skim/compare/v0.29.1...v0.30.0) (2026-08-17)


### Features

* Upgrade Nu version to 0.115 ([f71388b](https://github.com/idanarye/nu_plugin_skim/commit/f71388b0b89d59338b9da8f41fa198f2b00b83a9))


### Bug Fixes

* Merge pull request [#67](https://github.com/idanarye/nu_plugin_skim/issues/67) from sybereal/fix/highlighting ([82c64a9](https://github.com/idanarye/nu_plugin_skim/commit/82c64a92e1b860dd1a6a50f648e56f1076e2fb68))

## [0.29.1](https://github.com/idanarye/nu_plugin_skim/compare/v0.29.0...v0.29.1) (2026-07-07)


### Bug Fixes

* Type hints when `-m` is not used ([8313b3f](https://github.com/idanarye/nu_plugin_skim/commit/8313b3f2b31fd5d00ea4908038839c87e362ccd6))
...
* Upgrade Nu version to 0.113 ([30528cb](https://github.com/idanarye/nu_plugin_skim/commit/30528cb5c5f6decad9ccff7124b938cee36d08bd))

## [0.27.0](https://github.com/idanarye/nu_plugin_skim/compare/v0.26.1...v0.27.0) (2026-04-12)


### Features

* Make all the `ValueEnum` options case sensitive (like they are in Skim) ([3c43b93](https://github.com/idanarye/nu_plugin_skim/commit/3c43b939266e37df28285f65e7445ccde089a5e2))
...
* Add missing field (`SkimOptions::normalize`) that broke the build ([4be0254](https://github.com/idanarye/nu_plugin_skim/commit/4be0254ad49c62034cade1f3e72527f19474cc4c))

## [0.26.0](https://github.com/idanarye/nu_plugin_skim/compare/v0.25.0...v0.26.0) (2026-04-12)


### Features

* **ci,release:** add dist for automated release of precompiled binaries ([0b22e20](https://github.com/idanarye/nu_plugin_skim/commit/0b22e20e4ea101a3840b653fcec4a5c3651d363f))
* **ci,release:** add dist for automated release of precompiled binaries ([1647d5d](https://github.com/idanarye/nu_plugin_skim/commit/1647d5d0cf29b7b63384b8033711daba4900c14c))
* Upgrade Nu version to 0.112 ([bb4f7d0](https://github.com/idanarye/nu_plugin_skim/commit/bb4f7d0b6eb31e83c3eef2017f4d5c20e5050345))

## [0.25.0](https://github.com/idanarye/nu_plugin_skim/compare/v0.24.1...v0.25.0) (2026-03-02)


### Features

* Upgrade Nu version to 0.111 ([9bddd6d](https://github.com/idanarye/nu_plugin_skim/commit/9bddd6d65e46d88d87794bd2db187c71063b3c59))


### Reverts

* Downgrade skim to 1.*.* ([52f942c](https://github.com/idanarye/nu_plugin_skim/commit/52f942c092049f19cdaad5d520e4036f5cc3118c))
